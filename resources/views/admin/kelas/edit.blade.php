...
<div class="bg-blue-600 text-white p-6 shadow border">
 ...
 <p class="text-blue-100 mt-1">Ubah nama kelas.</p>
</div>
...
<div class="p-6">
 ...
 <div class="bg-white rounded-lg shadow p-6">
  <form action="{{ route('admin.kelas.update', $kela) }}" method="POST" class="max-w-md">
   @csrf @method('PUT')

   <div class="mb-4">
    <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Kelas</label>
    <input name="nama" type="text" value="{{ old('nama', $kela->nama) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg" />
   </div>
